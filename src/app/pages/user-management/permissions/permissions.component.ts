...
@Component({
  ...
  imports: [MaterialModule, TablerIconsModule, MatNativeDateModule, NgScrollbarModule, CommonModule],
...
export class PermissionsComponent implements AfterViewInit{
  ...
  openDialog(action: string, obj: any): void {
    obj.action = action;
    const dialogRef = this.dialog.open(PermissionDialogContentComponent, {
      data: obj,
    });
  ...
  addRowData(row_obj: Permission): void {
  ...
  // tslint:disable-next-line - Disables all
  updateRowData(row_obj: Permission): boolean | any {
  ...
  // tslint:disable-next-line - Disables all
  deleteRowData(row_obj: Permission): boolean | any {
    this.dataSource.data = this.dataSource.data.filter((value: any) => {
...
@Component({
  ...
  providers: [DatePipe],
  templateUrl: 'permissions-dialog-content.html'
})
// tslint:disable-next-line: component-class-suffix
export class PermissionDialogContentComponent {
  action: string;
  // tslint:disable-next-line - Disables all
  local_data: any;
  selectedImage: any = '';
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PermissionDialogContentComponent>,
    // @Optional() is used to prevent error if no data is passed
    @Optional() @Inject(MAT_DIALOG_DATA) public data: Permission
  ) {
